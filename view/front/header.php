<?php
    ...
    $connect_blog = new Imp();
    $db = $connect_blog->connection('blogsystem','','root','localhost');
    $connect_blog->show('blog', $db);
?>
...
<head>
    ...
    <?php foreach($connect_blog->rows as $row) {?>
        <title><?=$row['title']?> - <?=$row['description']?></title>
    ...
    <style>::-webkit-scrollbar {
        ...
        ::-webkit-scrollbar-thumb:hover {
         background: #555;  } @import url("https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap");
...
<header class="header" id="header">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="index.php" class="nav_logo"> <i class="bx bx-layer nav_logo-icon"></i> <span class="nav_logo-name">Blog</span> </a>
                <div class="nav_list"> <a href="index.php" class="nav_link active"> <i class="bx bx-grid-alt nav_icon"></i>
                 <span class="nav_name">Dashboard</span> </a> <a href="post.php" class="nav_link"> <i class="bx bx-user nav_icon"></i> 
                 <span class="nav_name">Users</span> </a> <a href="blog.php" class="nav_link"> <i class="bx bx-message-square-detail nav_icon"></i> 
                </div>
            </div> <a href="view/back/logout.php" class="nav_link"> <i class="bx bx-log-out nav_icon"></i> <span class="nav_name">SignOut</span> </a>
        </nav>
    </div>
